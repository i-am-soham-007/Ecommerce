        ...
        <div class="row">
            <div class="col">
                <div class="breadcrumb-contain">
                    <div>
                        <h2>{{ $subcatDetails['subcatDetails']['subcategory_name']}}</h2>
                        <ul>
                            <li><a href="index-2.html">home</a></li>
                            <li><i class="fa fa-angle-double-right"></i></li>
                            <li><a href="javascript:void(0)"> {{ $subcatDetails['subcatDetails']['subcategory_name']}}</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="top-banner-wrapper">
                                    <a href="javascript:void(0)"><img src="../assets/images/category/1.jpg" class="img-fluid  w-100" alt="category"></a>
                                                    ...
                                                    <div class="open-popup">
                                                        <div class="collection-filter category-side category-page-side">
                                                            ...
                                                            <div class="collection-filter-block creative-card creative-inner">
                                                                ...
                                                                <div class="collection-collapse-block open">
                                                                  <h3 class="collapse-block-title mb-3">colors</h3>
                                              ...
                                              <div class="product-imgbox">
                                                <div class="product-front">
                                                    <a href="product-page(left-sidebar).html">
                                                        ...
                                                        <img style="width:100px;" src="{{ asset('master-admin/assets/productImage/small/'.$product['main_image']) }}" class="img-fluid  " alt="product">
                                                        @else
                                                        <img style="width:80px;" src="{{ asset('master-admin/assets/productImage/small/no-image.png') }}" class="img-fluid  " alt="product">
                                                        @endif  
                                                    </a>
                                                </div>
