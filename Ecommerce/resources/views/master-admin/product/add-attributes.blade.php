		...
		<div class="page-wrapper">
			<div class="page-content">
				...
				<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
					<div class="breadcrumb-title pe-3">Product Attributes</div>
					<div class="ps-3">
                                    ...
                                    <div class="col-lg-6 col-sm-6 col-md-6">
                                        <div class="form-group">
                                            <div class="field_wrapper">
                                                <div>
                                                    <input type="text" name="size[]" id="size" style="width:120px;" placeholder="Size" value="" required/>
                                                    <input type="text" name="sku[]" id="sku" style="width:120px;" placeholder="SKU" value="" required/>
                                                    <input type="number" name="price[]" id="price" style="width:120px;" placeholder="Price" value="" required/>
                                                    <input type="number" name="stock[]" id="stock" style="width:120px;" placeholder="Stock" value="" required/>
            ...
            <form name="editAttributeForm" id="editAttributeForm" action="{{ url('admin/edit-attributes/'.$productdata['id'])}}" method="post">
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="card-title"><h5>Product Attribute List</h5>
                        </div>  
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="example2" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <input type="hidden" name="attrId[]" value="{{ $attributes['id'] }}>">
                                    <tr>
                                        <td>{{ $attributes['id'] }}</td>
                                        <td>{{ $attributes['size'] }}</td>
                                        <td>{{ $attributes['sku'] }}</td>
                                        <td> <input type="number" name="price[]" value="{{ $attributes['price'] }}"></td>
                                        <td> <input type="number" name="stock[]" value="{{ $attributes['stock'] }}"></td>
                                        <td>
                                            @if($attributes['status'] ==1)
                                                <a class="updateAttributeStatus" id="attribute-{{ $attributes['id'] }}" attribute_id ="{{ $attributes['id'] }}" href="javascript:void(0)">Active</a>
                                            @else 
                                                <a class="updateAttributeStatus" id="attribute-{{ $attributes['id'] }}"  attribute_id ="{{ $attributes['id'] }}" href="javascript:void(0)">Inactive</a>
                                            @endif
                                            &nbsp;&nbsp;
                                            <a href="javascript:void(0)" class="confirmDelete" record="attribute" recordid="{{ $attributes['id'] }}" title="delete Attribute"><i class="fa fa-trash"></i></a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
