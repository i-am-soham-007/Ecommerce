			...
			<div class="page-content">
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="{{ url('admin/add-edit-banner')}}" class="btn btn-block btn-success" style="width:150px;float: right;display:inline-block;"><i class="fa fa-plus"></i> Add Brand</a>
                        </div>
					</div>
                    <div class="card-body">
                            ...
                            <table id="example2" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{ $banner['id'] }}</td>
                                        <td>
                                            <?php $banner_image_path = "master-admin/assets/bannerImage/".$banner['image'];?>
											@if(!empty($banner['image']) && file_exists($banner_image_path))
											<img style="width:180px;" src="{{ asset('master-admin/assets/bannerImage/'.$banner['image']) }}">
											@else
											{{-- <img style="width:80px;" src="{{ asset('master-admin/assets/bannerImage/no-image.png') }}"> --}}
											@endif
                                        </td>
                                        <td>{{ $banner['link'] }}</td>
                                        <td>{{ $banner['title'] }}</td>
                                        ...
                                        <td>
                                            ...
                                            @endif
                                            &nbsp;&nbsp;
                                            <a href="{{ url('admin/add-edit-banner/'.$banner['id']) }}" title="edit banner"><i class="fa fa-edit"></i></a>
                                            &nbsp;&nbsp;
                                            <a href="javascript:void(0)" class="confirmDelete" record="banner" recordid="{{ $banner['id'] }}" title="delete banner"><i class="fa fa-trash"></i></a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
