			...
			<div class="page-content">
				...
				<div class="card">
				  <div class="card-body">
					  ...
					  <hr/>
                      <form action="{{ url('admin/update-admin-details')}}" method="post" id="update-form" enctype="multipart/form-data">
						@csrf
						   ...
						   <div class="col-lg-12 col-sm-12 col-md-12">
                               ...
                               <div class="alert alert-danger">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="username" name="username" value="{{ Auth::guard('admin')->user()->name}}" >
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    <label for="current-password" class="form-label">Mobile</label>
                                    <input type="text" class="form-control" id="mobile"  name="mobile" value="{{ Auth::guard('admin')->user()->phone}}" placeholder="Enter Current Password">
                                ...
                                <div class="mb-3">
                                    ...
                                    <a target="_blank" href="{{ url('master-admin/assets/profile/'.Auth::guard('admin')->user()->profile) }}">view Image</a>
                                    <input type="hidden" name="current_image" value="{{Auth::guard('admin')->user()->profile}}">
                                    @endif
                                </div>
