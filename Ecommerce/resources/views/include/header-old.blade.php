                ...
                <div class="top-header-right">
                   <ul>
                        ...
                        @if (Route::has('login'))
                            @auth
                            <li>
                                <a href="{{ url('/home') }}" class="text-sm text-gray-700 underline">my profile</a>
                            </li>
                            @else
                            <li>
             ...
             <div class="col-12">
                <div class="header-contain">
                   <div class="logo-block">
                      ...
                      <div class="brand-logo logo-sm-center"> <a href="index-2.html"> <img
                              src="{{ URL::asset('front-end/assets/images/mega-store/logo.png') }}" class="img-fluid  " alt="logo">
                      </a>
                      </div>
                   </div>
          ...
          <div class="row">
             <div class="col-12">
                <div class="category-contain">
                  ...
                  <?php
                  use App\Models\Category; $categories = Category::categories(); 
                  ?>
                            @foreach($categories as $category)
                            <li><a href="category-page(left-sidebar).html"><img src="{{ URL::asset('front-end/assets/category-image/'.$category['category_image']) }}" alt="">{{ $category['category_name'] }}</a></li>
                            @endforeach
                      ...
                      <div class="logo-block">
                         ...
                         <div class="brand-logo logo-sm-center">
                            <a href="index-2.html">
                               <img src="{{ URL::asset('front-end/assets/images/mega-store/logo.png') }}" class="img-fluid  " alt="logo">
                            </a>
                         </div>
                      </div>
                   </div>
                         ...
                         <nav id="main-nav">
                            ...
                            <ul id="main-menu" class="sm pixelstrap sm-horizontal">
                               ...
                               <li>
                                  ...
                                  <ul>
                                     <li><a  href="index-2.html">mega store 1</a></li>
                                     ...
                                     <li>
                                        <div class="container">
                                           ...
                                           <div class="row menu-banner">
                                              <div class="col-lg-6">
                                                 <div>
                                                    <img src="{{ URL::asset('front-end/assets/images/mega-store/menu-banner/1.jpg') }}" alt="menu-banner" class="img-fluid">
                                                 </div>
                                              </div>
                                              <div class="col-lg-6">
                                                 <div>
                                                    <img src="{{ URL::asset('front-end/assets/images/mega-store/menu-banner/2.jpg') }}" alt="menu-banner" class="img-fluid">
                                                 </div>
                                              </div>
                                           </div>
                                        </div>
                                        ...
                                        <div class="container">
                                           <div class="row">
                                                 ...
                                                 <div class="link-section">
                                                    ...
                                                    <div class="menu-content">
                                                       <ul>
                                                          ...
                                                          <li><a href="index-2.html">cart top</a></li>
                                              ...
                                              <div class="col mega-box product ">
                                                 <div class="mega-img">
                                                    <img src="{{ URL::asset('front-end/assets/images/mega-store/menu-banner/3.jpg') }}" alt="menu-banner" class="img-fluid">
                                                 </div>
                                              </div>
                                           </div>
                                        </div>
