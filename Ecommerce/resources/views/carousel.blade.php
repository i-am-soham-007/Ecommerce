	...
	<div class="row">
		<div class="col-md-12">
			...
			<div class="carousel-inner">
                @foreach($feturedItemsChunks as $key => $feturedItem)
                <div class="item carousel-item active">
					<div class="row">
                        @foreach($feturedItem as $item)
                            <div class="col-sm-3">
                                <div class="thumb-wrapper">
                                    <span class="wish-icon"><i class="fa fa-heart-o"></i></span>
                                    <div class="img-box">
                                        <?php $product_image_path = "master-admin/assets/productImage/small/".$item['main_image'];?>
											@if(!empty($item['main_image']) && file_exists($product_image_path))
											<img style="width:100px;" src="{{ asset('master-admin/assets/productImage/small/'.$item['main_image']) }}">
											@else
                                    ...
                                    <div class="thumb-content">
                                        ...
                                        <p class="item-price"> <b>RS.{{ $item['product_price'] }}</b></p>
